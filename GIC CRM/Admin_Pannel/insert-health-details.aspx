<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_Pannel/admin_master.master" AutoEventWireup="true" CodeFile="insert-health-details.aspx.cs" Inherits="nyksi_panel_Upload_Main_Product" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="row-fluid">
        <div class="span12">
            ...
            <h3 class="page-title">Insert Health Details
                    <%-- <small>form components and widgets</small>--%>
            </h3>
            <ul class="breadcrumb">
                <li><a href="Default.aspx"><i class="icon-home"></i></a><span class="divider">&nbsp;</span></li>
                <li><a href="#">Health</a><span class="divider">&nbsp;</span></li>                <li><a href="#">Insert Health Details</a><span class="divider-last">&nbsp;</span></li>
            </ul>
        </div>
    </div>
                                ...
                                <div class="span6">                                  
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtpremium" ValidationGroup="tt" ErrorMessage="Pls. Enter Premium Amount" ForeColor="#cc3300"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                     ...
                                     <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtduration" ValidationGroup="tt" ErrorMessage="Pls. Enter Duration" ForeColor="#cc3300"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input id="txtexpirydate"  runat="server" class="m-ctrl-medium date-picker" width="100%"  type="text" value="12-02-2012" />
                                             <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtexpirydate" ValidationGroup="tt" ErrorMessage="Pls. Enter Expiry Date" ForeColor="#cc3300"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>                                
                                </div>
                                <div class="span6">
