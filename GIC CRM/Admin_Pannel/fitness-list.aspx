<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_Pannel/admin_master.master" AutoEventWireup="true" CodeFile="fitness-list.aspx.cs" Inherits="nyksi_panel_banner" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="row-fluid">
        <div class="span12">
            ...
            <h3 class="page-title">Fitness List
                    <%-- <small>form components and widgets</small>--%>
            </h3>
            <ul class="breadcrumb">
                <li><a href="Default.aspx"><i class="icon-home"></i></a><span class="divider">&nbsp;</span></li>
                <%--<li><a href="#">Home</a><span class="divider">&nbsp;</span></li>--%>
                <li><a href="#">Fitness List</a><span class="divider-last">&nbsp;</span></li>
            </ul>
        </div>
    </div>
        ...
        <div class="span12">
            <div class="widget">
                <div class="widget-title">
                    <h4><i class="icon-user"></i>Manage Fitness List Here</h4>
                </div>
                    ...
                    <form action="#" class="form-horizontal" id="fhgfh" runat="server">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <asp:Button ID="Btnsearchbyvehicleno" runat="server" Text="Search" CssClass="btn btn-success" ValidationGroup="ttpp" OnClick="Btnsearchbyvehicleno_Click"></asp:Button>
                            </div>
                        </div>
                                ...
                                <asp:GridView ID="grdGic" runat="server" PageIndex="1"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                                            ...
                                            <ItemTemplate>
                                                <a href="edit-fitness.aspx?id_x=<%#Eval("id") %>">View/Edit</a>
                                            </ItemTemplate>
                                        </asp:TemplateField>
