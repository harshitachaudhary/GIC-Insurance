<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_Pannel/admin_master.master" AutoEventWireup="true" CodeFile="edit-fitness.aspx.cs" Inherits="nyksi_panel_Upload_Main_Product" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="row-fluid">
        <div class="span12">
            ...
            <h3 class="page-title">Edit Fitness List
                    <%-- <small>form components and widgets</small>--%>
            </h3>
            <ul class="breadcrumb">
                <li><a href="Default.aspx"><i class="icon-home"></i></a><span class="divider">&nbsp;</span></li>
                <li><a href="fitness-list.aspx">Fitness List</a><span class="divider">&nbsp;</span></li>
                <li><a href="#">Edit Fitness</a><span class="divider-last">&nbsp;</span></li>
            </ul>
        </div>
    </div>
    <div class="row-fluid">
        <div class="span12">
            <div class="widget">
                <div class="widget-title">
                    <h4><i class="icon-user"></i>Update Fitness List Here</h4>
                </div>
                                ...
                                <div class="span6">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txteditduration" ValidationGroup="tt" ErrorMessage="Product SrerialNo" ForeColor="#cc3300"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txteditmobileno" ValidationGroup="tt" ErrorMessage="Product SrerialNo" ForeColor="#cc3300"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
