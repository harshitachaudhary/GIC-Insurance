...
public partial class nyksi_panel_Upload_Main_Product : System.Web.UI.Page
{
    ...
    protected void btnsubmit_Click1(object sender, EventArgs e)
    {
        try
        {
            ...
            cmd.Parameters.AddWithValue("@insurance_company_name", txticn.Text);
            cmd.Parameters.AddWithValue("@name", txtname.Text);
            cmd.Parameters.AddWithValue("@address", txtaddress.Text);
            cmd.Parameters.AddWithValue("@vehicle_no", txtvehicleno.Text);
            cmd.Parameters.AddWithValue("@registration_date", txtregdate.Value);
            cmd.Parameters.AddWithValue("@model", txtmodel.Text);
            cmd.Parameters.AddWithValue("@NCB", txtncb.Text);
            ...
            if (i > 0)
            {
                ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Successfully Submited');location.href='insert-gic-details.aspx'", true);
            }
            else
            {
