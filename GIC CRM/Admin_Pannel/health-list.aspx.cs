...
public partial class nyksi_panel_banner : System.Web.UI.Page
{
    ...
    protected void lbdelete_Click(object sender, EventArgs e)
    {
        ...
        if (i > 0)
        {
            ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Successfully Deleted');location.href='health-list.aspx'", true);
        }
        con.Close();
    }
    ...
    {
        string s = "select * from tblhealth where name like '%" + txtsearchbyname.Text + "%'";
