<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_Pannel/admin_master.master" AutoEventWireup="true" CodeFile="testimonials.aspx.cs" Inherits="nyksi_panel_Upload_Main_Product" %>
        ...
        <div class="span12">
            <div class="widget">
                <div class="widget-title">
                    <h4><i class="icon-user"></i>Manage Here <span style="color: red;">(Note :- Image Width:100px & Height:100px)</span></h4>
                </div>
