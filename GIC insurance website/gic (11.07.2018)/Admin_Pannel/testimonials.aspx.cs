...
public partial class nyksi_panel_Upload_Main_Product : System.Web.UI.Page
{
    ...
    protected void gvDetails_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
       ...
       // string username = gvDetails.DataKeys[e.RowIndex].Values["UserName"].ToString();
        ...
        lblresult.Text = txtheading.Text + " Details Updated successfully";
    ...
    protected void gvDetails_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
       ...
       // string username = gvDetails.DataKeys[e.RowIndex].Values["UserName"].ToString();
        Label lblname = (Label)gvDetails.Rows[e.RowIndex].FindControl("lblitemUsr");
        con.Open();
        SqlCommand cmd = new SqlCommand("proc_tbltesti", con);
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.Parameters.AddWithValue("@id", userid);
    ...
    protected void gvDetails_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName.Equals("AddNew"))
        {
            ...
            {
                lblresult.ForeColor = Color.Red;
                lblresult.Text = txtUsrname.Text + "Some Error Occurred!!!";
            }
        }
    }
