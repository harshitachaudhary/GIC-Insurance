<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_Pannel/admin_master.master" AutoEventWireup="true" CodeFile="about-us.aspx.cs" Inherits="nyksi_panel_Upload_Main_Product" %>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="row-fluid">
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <cc1:Editor ID="Editorpara1" runat="server" Height="300px" Width="350px" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="span6">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <cc1:Editor ID="Editorpara2" runat="server" Height="300px" Width="350px" />
                                        </div>
                                    </div>
                                </div>
                            </div>
