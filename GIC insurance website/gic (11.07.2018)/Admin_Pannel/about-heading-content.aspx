<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_Pannel/admin_master.master" AutoEventWireup="true" CodeFile="about-heading-content.aspx.cs" Inherits="nyksi_panel_Upload_Main_Product" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="row-fluid">
        <div class="span12">
            ...
            <h3 class="page-title">About Heading
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="#">About Heading</a><span class="divider-last">&nbsp;</span></li>
            </ul>
        </div>
    </div>
