            ...
            <div class="widget-body">
                ...
                <div class="about-us">
                    <div class="alert alert-info">
                        ...
                        Welcome to the <strong>INSURANCE GIC</strong>. Please don't forget to check all the pages!  
                    </div>
                    <div class="alert alert-info">
                        <button data-dismiss="alert" class="close">×</button>
                    ...
                    <div class="row-fluid circle-state-overview">
                        <div class="span2 responsive clearfix" data-tablet="span3" data-desktop="span2">
                            <div class="circle-wrap">
                                ...
                                <p>
                                    <%--<strong>+30</strong>--%>
                                    <a href="logo.aspx">Change Logo</a>
                                </p>
                            </div>
                        </div>
                        <div class="span2 responsive clearfix" data-tablet="span3" data-desktop="span2">
                            <div class="circle-wrap">
                                ...
                                <p>
                                    <%--<strong>+30</strong>--%>
                                    <a href="main-banner.aspx">Main Banner</a>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="span2 responsive" data-tablet="span3" data-desktop="span2">
                            <div class="circle-wrap">
                                ...
                                <p>
                                    <%--<strong>+970</strong>--%>
                                    <a href="service-details.aspx">Add Services</a>
                                </p>
                            </div>
                        </div>
                        <div class="span2 responsive clearfix" data-tablet="span3" data-desktop="span2">
                        ...
                        <div class="span2 responsive" data-tablet="span3" data-desktop="span2">
                            <div class="circle-wrap">
                                ...
                                <p>
                                    ...
                                    <a href="contact-query-list.aspx">Contact Queries</a>
                                </p>
                            </div>
                        </div>
                    </div>
