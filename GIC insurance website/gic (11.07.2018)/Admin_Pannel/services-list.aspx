<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_Pannel/admin_master.master" AutoEventWireup="true" CodeFile="services-list.aspx.cs" Inherits="nyksi_panel_banner" %>
    ...
    <div class="row-fluid">
        <div class="span12">
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="#">Services List</a><span class="divider-last">&nbsp;</span></li>
            </ul>
        </div>
    </div>
                            ...
                            <div class="row-fluid">
                                <asp:GridView ID="grdcategory" runat="server" PageIndex="1"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                                            <HeaderTemplate>Service Content</HeaderTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="lblheading2" runat="server" Text='<%#Eval("service_content") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                  
                                        <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                                            <HeaderTemplate>Service Image</HeaderTemplate>
                                            <ItemTemplate>
                                                <asp:Image ID="Image1" runat="server" ImageUrl='<%#Eval("service_image") %>' Width="200px" Height="100px" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
